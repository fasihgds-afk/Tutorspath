        ...
        <div className="grid grid-cols-2 gap-3 md:hidden">
          {stats.map((stat) => (
            <div key={stat.id}
              ...
              <div className="w-11 h-11 rounded-xl bg-primary-soft border border-primary-border flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                {stat.icon}
              </div>
        ...
        <div className="hidden md:flex bg-surface rounded-[20px] shadow-xs border border-card-border px-6 sm:px-10 lg:px-12 py-7 items-center justify-between gap-0 divide-x divide-gray-100 hover:shadow-md transition-shadow duration-300">
          {stats.map((stat, idx) => (
            <div key={stat.id}
              ...
              <div className="w-12 h-12 rounded-xl bg-primary-soft border border-primary-border flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
                {stat.icon}
              </div>
